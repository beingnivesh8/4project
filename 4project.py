...
<div style='text-align:center'>
    <h1 style='color:;'>Industrial Copper Modeling Application</h1>
</div>
...
if selected == 'Predictions':
    ...
    with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\4. Copper\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\Users\N.P.Nivesh\Desktop\Python\Projects\4. Copper\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\4. Copper\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\PY file\s.pkl", 'rb') as f:
    ...
    with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\PY file\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'C:\Users\N.P.Nivesh\Desktop\Python\Projects\PY file\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\PY file\ct.pkl", 'rb') as f:
